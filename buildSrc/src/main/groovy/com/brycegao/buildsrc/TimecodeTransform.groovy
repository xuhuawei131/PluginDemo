...
class TimecodeTransform extends Transform {

  private Project mProject
  private SrcConfig mConfig

  TimecodeTransform(Project p, SrcConfig config) {
    mProject = p
    mConfig = config
  }
  ...
  void transform(TransformInvocation transformInvocation)
    ...
    transformInvocation.inputs.each { TransformInput input ->
      ...
      input.directoryInputs.each { DirectoryInput directoryInput ->
        SrcUtils.injectTimeCode(directoryInput.file.getAbsolutePath(), mProject, mConfig)
      ...
      input.jarInputs.each { JarInput jarInput ->
        SrcUtils.injectTimeCode(jarInput.file.getAbsolutePath(), mProject, mConfig)
